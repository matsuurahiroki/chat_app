  ...
  return (
    <>
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8">
        <div className="mt-2">
          <p className="font-semibold text-cyan-400 mb-3 text-base sm:text-lg">
            ログアウト
          </p>
        ...
        <div className="mt-20">
          ...
          <form className="mt-5">
            <Button
              ...
              className={
                "w-full md:w-40 rounded-lg text-white text-sm sm:text-base font-semibold py-2 bg-red-500 hover:bg-red-600"
              }
            >
              アカウント削除
            </Button>
      ...
      <DeleteAccountModal opened={isOpen} onClose={() => setIsOpen(false)} />
    </>
  );
};
